...
<div class="row">
  <div class="col-md-1"></div>
    <div class="col-md-10">
      <div class="card">
        <div class="card-body">
          <form action="<?php echo site_url(); ?>/terrenos/procesarActualizacion" method="post" id="frm_editar_terreno" enctype="multipart/form-data" >
            <div class="row">
              <div class="col-md-4">
                <input type="hidden" name="id_ter" id="id_ter" value="<?php echo $terreno->id_ter; ?>">
              ...
              <div class="col-md-4">
                ...
                <textarea name="descripcion_ter" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" id="descripcion_ter"class="form-control"rows="2" cols="80"><?php echo $terreno->descripcion_ter; ?></textarea><br>
              </div>
              <hr>
              <div class="col-md-1"></div>
              <div class="col-md-10">
                ...
                <div class="text-center">
                  <input type="file" name="foto_ter" accept="image/*" id="foto_ter"  value="<?php echo $terreno->foto_ter; ?>" ><br>
                </div>
                <?php date_default_timezone_set('America/Guayaquil');
                  $fecha_actual=date("Y-m-d H:i:s",time());
                ?>
                <input class="form-control"  type="hidden" name="fecha_creacion_ter" id="fecha_creacion_ter" value="<?php echo $terreno->fecha_creacion_ter; ?>" readonly>
                <br>
              </div>
              <div class="col-md-1"></div>
              <br>
              ...
              <hr>
                <div class="col-md-4">
                  ...
                  <input class="form-control" type="text" name="lat_ter" id="lat_ter" value="<?php echo $terreno->lat_ter; ?>" placeholder="Por favor Seleccione la latitud" readonly>
                </div>
                <div class="col-md-4">
                  <label for="" class="text-dark"><b>LONGITUD</b></label>
                  <input class="form-control" type="text" name="lng_ter" id="lng_ter" value="<?php echo $terreno->lng_ter; ?>" placeholder="Por favor Seleccione la longitud" readonly>
                </div>
                <div class="col-md-4"></div>
                <br><br><br><br>
                <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCRfI1Rxdj986JJnod5U94SfJ5YGCOc1xE&libraries=places&callback=initMap"></script>
                <div class="row">
                  <div class="col-md-12">
...
<script type="text/javascript">
  ...
  $("#fk_id_produc").val("<?php echo $terreno->fk_id_produc; ?>");
  $("#fk_id_pro").val("<?php echo $terreno->fk_id_pro; ?>");
  $("#fk_id_par").val("<?php echo $terreno->fk_id_par; ?>");
  $("#fk_id_bar").val("<?php echo $terreno->fk_id_bar; ?>");
  $("#tiempo_cosecha_ter").val("<?php echo $terreno->tiempo_cosecha_ter; ?>");
